        ...
        <html>
            <head>
                ...
                <style>
                    ...
                    footer {padding: 2% 0; text-align: center; font-weight: 700; position: relative; top: 150px;}
                    .img {height: 90%; position: absolute; z-index: -1; top: 5%; left: 60%;}
                    button {background-color: #05386b; color: #edf5e1; border: none; border-radius: 5px; cursor: pointer; font-size: 100%; padding: 1% 2%;}
                    button:hover {background-color: #379684;}
                    .conteiner {margin: 0 15%; background-color: white; text-align: center; padding: 2% 0;}
                    header h1 {margin: 0 10%;}
                    select{appearance: none; border: none; outline: none; background: none; font-size: 100%; font-weight: 700; padding: 20% 20%; color: #05386b; font-family: "Exo 2", sans-serif;}
                    ...
                    .conteiner h1 {margin: 0;}
                    h3 {margin-left: 20%; text-align: left; font-size: 1.4em;}
                    ul {list-style-type: none; padding: 0; font-size: 120%; margin-left: 20%; text-align: left;}
                    .correct {color: green;}
                    .incorrect {color: red;}
                    .explanation {display: none; color: darkgreen;}
                </style>
            </head>
            <body>
                <header>
