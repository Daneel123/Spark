  ...
  function changeLanguage(language) {
    switch (language) {
      default:
        ...
        $('.first-div').html('<a href="create/create_ru.html" target="_self"><button>Начать</button></a>');
        break;
      case 'kz':
        $('h1').text('Spark');
        ...
        $('.first-div').html('<a href="create/create_kz.html" target="_self"><button>Бастау</button></a>');
        break;
      case 'en':
        $('h1').text('Spark');
        ...
        $('.first-div').html('<a href="create/create_en.html" target="_self"><button>Start</button></a>');
    }
  }
});